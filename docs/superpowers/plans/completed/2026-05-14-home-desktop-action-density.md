...
- [x] **Step 1: Change the no-training Home expectation**
...
- [x] **Step 3: Move secondary support CTA into details when opted in**
...
- [x] **Step 4: Opt in from the Home Focus hero**
...
- [x] **Step 3: Capture fresh route evidence**
...
- [x] **Step 4: Record the scope decision**

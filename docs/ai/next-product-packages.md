...
2026-05-21 route evidence first captured 9 desktop and 15 mobile screenshots and found narrow first-viewport friction, but no new package-sized backlog: the Plan mobile scenario preview label now says `Nur Vorschau`, and Home learning calibration no longer steals completed-day review or leaves calibration CTAs with generic fallback detail. Current-main route evidence at `7a09cd2` captures 9 desktop and 17 mobile screenshots with 0 horizontal overflow, including the Data Fueling Tagesaktion, focused Activity Fueling closure anchor and Plan mobile scenario preview; no additional daily-flow or Fueling UI/UX slice is currently justified. See `docs/qa/2026-05-21-performance-os-next-evidence.md`, `docs/qa/2026-05-21-plan-preview-label-evidence.md`, `docs/qa/2026-05-21-home-calibration-review-clarity.md`, `docs/qa/2026-05-21-post-fueling-route-evidence.md` and `docs/qa/2026-05-21-current-main-route-evidence.md` before proposing new UI/UX work from current route state.

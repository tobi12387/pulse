...
2026-05-21 route evidence first captured 9 desktop and 15 mobile screenshots and found narrow first-viewport friction, but no new package-sized backlog: the Plan mobile scenario preview label now says `Nur Vorschau`, Home learning calibration no longer steals completed-day review or leaves calibration CTAs with generic fallback detail, Home translates primary learning-calibration actions as `Lernschleife`/`Muster pruefen` instead of analysis jargon, and Activity Fueling deep links now focus the GI comfort action group when that is the missing evidence. Latest current-main route evidence at `2f41418` in `docs/qa/2026-05-21-current-route-evidence-2f41418.md` extends the `ae3285d`/`93e6036` route passes: 9 desktop and 17 mobile screenshots still had 0 horizontal overflow, the Activity Fueling closure path uses sport-neutral `langen During-Log` copy for long endurance logs, Fueling readiness exposes both existing completion candidates in app/audit while preserving the 3/3 trend gate, the iPhone field packet and Performance gate metadata carry current-commit iPhone rerun commands, and the refreshed audit keeps Fueling and iPhone/PWA field evidence gated while the server mirror verifies ready at `2f41418`. The iPhone/PWA audit now also treats stale `Server commit under test` field evidence as a gate gap, so the old `9e05189` manual record cannot prove the current expected commit; use the live audit command for the exact current hash instead of creating docs-only hash-refresh PRs. Simulated iPhone WebKit evidence at `9b6c7d7` fixed a concrete Home stage-strip `JETZT` clipping issue and passed the bounded WebKit PWA gate, but it does not replace real-device iPhone/VPN/PWA field evidence. No additional daily-flow or Fueling UI/UX slice is currently justified. See `docs/qa/2026-05-21-performance-os-next-evidence.md`, `docs/qa/2026-05-21-plan-preview-label-evidence.md`, `docs/qa/2026-05-21-home-calibration-review-clarity.md`, `docs/qa/2026-05-21-post-fueling-route-evidence.md`, `docs/qa/2026-05-21-current-main-route-evidence.md`, `docs/qa/2026-05-21-current-main-route-evidence-20caf40.md`, `docs/qa/2026-05-21-current-main-evidence-0d8cd63.md`, `docs/qa/2026-05-21-current-main-evidence-ae3285d.md`, `docs/qa/2026-05-21-current-main-evidence-ec77c26.md`, `docs/qa/2026-05-21-current-main-route-evidence-9ac97fc.md`, `docs/qa/2026-05-21-current-route-evidence-2f41418.md`, `docs/qa/2026-05-21-current-gates-4c046ab.md`, `docs/qa/2026-05-21-current-gates-5477d49.md`, `docs/qa/2026-05-21-iphone-field-commit-freshness.md`, `docs/qa/2026-05-21-iphone-webkit-stage-strip.md`, `docs/qa/2026-05-21-activity-fueling-action-focus.md`, `docs/qa/2026-05-21-home-learning-language.md`, `docs/qa/2026-05-21-fueling-long-session-copy.md`, `docs/qa/2026-05-21-fueling-evidence-checklist.md`, `docs/qa/2026-05-21-iphone-field-checklist-audit.md`, `docs/qa/2026-05-21-iphone-field-recovery-packet.md`, `docs/qa/2026-05-21-performance-iphone-recovery-metadata.md` and `docs/qa/2026-05-21-server-runbook-gate-render.md` before proposing new UI/UX work from current route state.

Fresh current-main route evidence at `2b7a139` in `docs/qa/2026-05-21-current-route-evidence-2b7a139.md` again captured 9 desktop and 17 mobile screenshots with 0 horizontal overflow. Manual review of Home, Data Fueling, Activity Fueling, mental quick check and Plan scenario preview found no new UI/UX implementation slice; the current blockers remain manual Fueling GI comfort evidence and real iPhone/PWA evidence.

...
- Training-plan next slice after custom workout planning and off-plan Garmin Home closure: continue from the Training Intelligence control layer now used in generated workout descriptions for archetype labels and repeated-week variation; next deepen long-ride fueling/tolerance feedback and future plan guidance.

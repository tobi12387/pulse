...
- Latest verified server runtime recorded in this file before the current branch: `ed04697` / PR #284, deployed 2026-05-10. Verify live deploy state with `scripts/verify-server.sh` when it matters.

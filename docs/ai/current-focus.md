...
- Latest verified server runtime recorded in this file before the current branch: `1f963af` / PR #295, deployed 2026-05-10. Verify live deploy state with `scripts/verify-server.sh` when it matters.

...
- Training-plan next slice after custom workout planning and off-plan Garmin Home closure: continue from the Training Intelligence control layer now used in generated workout descriptions for archetype labels and repeated-week variation. Fueling guidance now learns from During logs with GI comfort, bottles, powder and activity duration; next deepen how this affects weekly plan choice and UI surfacing.

...
- Current navigation baseline is Home, Data, Plan and Settings, with Insights inside Data and `/coach` as a compatibility/deep-link route. Future tabs, areas or modes are allowed when they make a recurring flow clearer or calmer; validate with route evidence before changing primary navigation.

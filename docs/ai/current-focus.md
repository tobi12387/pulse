...
- Latest verified server runtime recorded in this file: `8a384ab` / PR #221, deployed 2026-05-09. Verify live deploy state with `scripts/verify-server.sh` when it matters.

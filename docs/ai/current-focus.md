...
- Current hard Performance-OS backlog order is kept as ready package cards in `docs/ai/next-product-packages.md` so agents do not re-plan from scratch:
  1. **Lernschleifen:** group repeated reopen sources into trend-level learning.
  2. **Tagesentscheidung:** show whether today's fresh reopen is isolated or part of a repeated source trend.
  3. **Trainingsanpassung:** turn repeated reopen-source trends into a weekly decision context.
- Shipped baselines:

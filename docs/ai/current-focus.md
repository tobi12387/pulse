...
- No next runtime UI/UX slice is selected from current route evidence. Nutrition Trend Summaries remain data-gated, now with visible `Trend-Evidenz x/3` readiness in Fueling baselines; Mobile Field Reliability remains a real-iPhone gate.

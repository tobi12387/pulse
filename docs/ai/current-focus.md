...
- Latest verified server runtime recorded in this file: `d1ddd88` / PR #220, deployed 2026-05-09. Verify live deploy state with `scripts/verify-server.sh` when it matters.

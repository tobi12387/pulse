...
- Latest verified server runtime recorded in this file before the current branch: `c1af5b9` / PR #268, deployed 2026-05-10. Verify live deploy state with `scripts/verify-server.sh` when it matters.

...
- No next runtime UI/UX slice is selected from current route evidence. Nutrition Trend Summaries remain data-gated, and Mobile Field Reliability remains a real-iPhone gate.

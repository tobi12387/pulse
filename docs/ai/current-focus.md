...
- Next non-gated long-term work should create a PR-sized Predictive Goal Engine v1 plan that consumes Personal Response evidence read-only before any automatic plan or coach behavior changes.

...
- Next non-gated long-term work should create a PR-sized Contextual Coach Mode plan that consumes response, goal and season-contract evidence read-only before changing Coach behavior.

...
- Mental Check-in Simplification: Data > Mental uses Garmin-assisted quick choices with the existing numeric check-in contract. Next slices are voice/free-text first and Home placement from `docs/superpowers/plans/2026-05-04-mental-checkin-simplification.md`.

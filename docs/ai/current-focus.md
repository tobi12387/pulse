...
- Latest verified server runtime recorded in this file: `92d4d34` / PR #222, deployed 2026-05-09. Verify live deploy state with `scripts/verify-server.sh` when it matters.

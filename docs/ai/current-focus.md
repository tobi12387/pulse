...
- Remaining roadmap work is gated: Nutrition Trend Summaries only when repeated fueling logs exist, optional Daily Delta/Garmin wording only when route evidence or user feedback shows a real gap, and Mobile Field Reliability remains a real-iPhone gate.

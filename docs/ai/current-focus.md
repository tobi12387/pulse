...
- Next non-gated long-term work should create a PR-sized Adaptive Season Builder v1 plan that consumes goal projection evidence read-only before any automatic season or coach behavior changes.

...
- Latest verified server runtime recorded in this file before the current branch: `acef263` / PR #208, deployed 2026-05-06. Verify live deploy state with `scripts/verify-server.sh` when it matters.

...
- Next implementation order: real iPhone/PWA field evidence and Mobile Field Reliability fixes if evidence reveals any; otherwise Garmin Signal Usefulness Wave, then Daily Decision Quality Loop.

...
- Current active plan family: `docs/superpowers/plans/2026-05-02-future-direction-roadmap.md`, plus Daily Loop Explainability and Mobile Field Reliability.
- Next implementation order: real iPhone/PWA field evidence, Mobile Field Reliability fixes if evidence reveals any, Daily Loop Explainability, then Adaptive Training Intelligence v2, Mental Fitness Companion, Garmin Data Quality Control Center, Goal/Race Command Center and Local Ops Autopilot.

...
- Current active plan: `docs/superpowers/plans/2026-05-01-ui-ux-usability-wave.md`.
- Next implementation order: Usability E2E foundation plus Insights error guard, Home/Coach Daily Flow, Plan Decision Flow, Data/Settings Trust, Visual Density Pass.

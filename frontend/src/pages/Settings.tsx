...
import type { PulseCoachCommunicationStyle, PulseCoachPreferences, PulseGarminCoverageRepairAction, PulseProfileMetricProvenance } from '@coaching-os/shared/pulse';
...
function WrapVal({ children }: { children: React.ReactNode }) {
  return (
    <span style={{
      fontFamily: 'var(--font-mono)',
      fontSize: 12,
...
function CoachPreferencesCard({ setMessage }: {
...
const settingsTextAreaStyle: React.CSSProperties = {
  width: '100%',

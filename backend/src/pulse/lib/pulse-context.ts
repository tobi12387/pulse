...
export async function buildPulseContextFor(userId: string, date: string): Promise<PulseContext> {
  ...
  return {
    ...
    coachPreferences: coachPreferencesRow ? {
      ...
      supportWarningSigns: coachPreferencesRow.supportWarningSigns,
      supportStabilizingActions: coachPreferencesRow.supportStabilizingActions,
      supportContactNote: coachPreferencesRow.supportContactNote,
      supportActivationPreference: coachPreferencesRow.supportActivationPreference,
